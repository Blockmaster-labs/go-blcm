...
pruning. Remember don't start the blcmwithout deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "blcmsnapshot prune-state --help" for more details.
`
