...
// It can be used for testing that restart blcmnormally.
...
// It can be used for testing that restart blcmafter the crash.
...
// Tests a blcmrestart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a blcmwas crashed and restarts with a broken snapshot. In this case the
...
// Tests a blcmwas crashed and restarts with a broken snapshot. In this case
...
// Tests a blcmwas running with snapshot enabled. Then restarts without
...
// Tests the blcmwas running with snapshot enabled and resetHead is applied.
...
// Tests the blcmwas running with a complete snapshot and then imports a few
