...
// GCStats retrieves the current garbage collection stats from a blcmnode.
...
// MemStats retrieves the current memory stats from a blcmnode.
...
// GetNodeInfo retrieves the node info of a blcmnode.
