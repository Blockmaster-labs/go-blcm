...
*It is worth noting that the connected blcmnode can be a fullnode or a light client. If it is fullnode, you must enable the LES protocol. E.G. add `--light.serv 50` to the startup command line flags*.
...
* Get your node configuration file `blcmdumpconfig OTHER_COMMAND_LINE_OPTIONS > config.toml`
...
* Start blcmwith the modified configuration file
