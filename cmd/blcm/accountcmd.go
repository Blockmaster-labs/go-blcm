...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    blcmwallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
	blcmwallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    blcmaccount update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    blcmaccount import [options] <keyfile>
