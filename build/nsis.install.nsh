Name "blcm${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "blcmincoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "blcmoutgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "blcmUDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "blcmincoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "blcmoutgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "blcmUDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
